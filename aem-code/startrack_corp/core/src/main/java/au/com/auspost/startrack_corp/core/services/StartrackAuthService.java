 ...
 */
@SlingServlet(paths="/bin/StartrackAuthService", methods = "GET", metatype = true)
@Property(name = "sling.auth.requirements", value = "-/bin/StartrackAuthService")
public class StartrackAuthService extends SlingSafeMethodsServlet {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(StartrackAuthService.class);
