 ...
 * Issue :  <div data-sly-resource="${'bodyTextSmall' @ resourceType='startrack_global/components/rte-components/text-body'}" data-sly-unwrap/>
 * cq:include of the above startrack_global/components/rte-components/text-body does not automatically create the node bodyTextSmall
 * Usage as below:
 * <div data-sly-use.inlineEdit="${'au.com.auspost.startrack_global.core.sightly.InlineEditNodeGenerator'@ paramNodeType='startrack_global/components/rte-components/text-heading',nodeToBeCreated='hero-heading-text-2'}"
 * data-sly-unwrap/>
