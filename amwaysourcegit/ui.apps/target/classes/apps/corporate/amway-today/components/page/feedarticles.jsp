...
%><%@ page import="com.adobe.granite.license.ProductInfo,
                   ...
                   org.strut.amway.core.controller.FeedArticlesController" %><%
...
%><cq:defineObjects /><%
    ...
    try {
        ...
        FeedArticlesController feedArticlesController = new FeedArticlesController(currentPage, sling, slingRequest);
        List<Page> pages = feedArticlesController.getListChildren();
		for (Page p : pages) {
