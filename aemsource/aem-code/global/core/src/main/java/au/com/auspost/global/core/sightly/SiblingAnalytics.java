...
import au.com.auspost.global.core.util.AusPostStringUtils;
 ...
 *  <div data-sly-use.cta="${'au.com.auspost.global.core.sightly.SiblingAnalytics'@ childNode='hero-heading-text-1',childNodeProperty='text'}"
 * data-sly-unwrap></div>
 */
